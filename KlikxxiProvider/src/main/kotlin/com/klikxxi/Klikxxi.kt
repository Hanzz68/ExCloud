...
open class Klikxxi : MainAPI() {
    ...
    private fun Element.toRecommendResult(): SearchResponse? {
        ...
        val href = fixUrl(link.attr("href"))
        val posterUrl = fixUrlNull(this.selectFirst("a > img")?.attr("data-src") ?: this.selectFirst("a > img")?.attr("src"))
    ...
    override suspend fun load(url: String): LoadResponse {
        ...
        val poster = fixUrlNull(document.selectFirst("figure.pull-left > img")?.attr("data-src") ?: document.selectFirst("figure.pull-left > img")?.attr("src"))
